...
<html>
  ...
  <body>
   <div id="logo"></div>
    ...
    <div id="daohang">
    <ul>
    <li><a href="caigou.html" id="beijing">采购管理</a></li>
   ...
   String sql="select count(*) from yuanliao order by 序号 asc";
   ...
   currentPage=1;
    ...
    <tr>
    <td colspan="8" align="center"  height="50px"><h3>原料信息(共<%=rows %>条记录)</h3>
    </td>
    </tr>
    <%
    sql="select * from yuanliao order by 序号 asc limit "+(currentPage-1)*rowsPage+","+rowsPage;
    rs=db.executeQuery(sql);
     %>
    <tr>
    <td width="50">序号</td>
    <td width="150" height="50px">原料编码</td>
    <td width="360">原料名称</td>
    <td width="150">市场价格(元/kg)</td>
  ...
  <% 
    ...
    <td width="100"><a href="yuanliaoxiugai.jsp?id=<%=rs.getInt(1) %>" >修改</a></td>
    <td width="100"><a href="yuanliaodelete.jsp?id=<%=rs.getInt(1) %>" style="color:red; " onclick='return window.confirm("确定要删除此原料信息吗？请慎重！！！")'>删除</a></td>
    </tr>
   <%  }
  db.close();%>
    </table>
    ...
    <center>
    <a href="yuanliao.jsp?currentPage=<%=currentPage-1 %>">上一页</a>&nbsp;
    <a href="yuanliao.jsp?currentPage=<%=currentPage+1 %>">下一页</a>
    &nbsp;&nbsp;共<%=totalPage %>页
   </center>
