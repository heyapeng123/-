...
<html>
  ...
  <body>
   ...
   currentPage=1;
    ...
    <tr>
    <td colspan="9" align="center"  height="50px"><h3>客户信息(共<%=rows %>条记录)</h3>
    </td>
    </tr>
    <%
  ...
  <% 
    ...
    <td width="100"><a href="kehuxiugai.jsp?id=<%=rs.getInt(1) %>" >修改</a></td>
    <td width="100"><a href="kehudelete.jsp?id=<%=rs.getInt(1) %>" style="color:red; " onclick='return window.confirm("确定要删除此客户信息吗？请慎重！！！")'>删除</a></td>
    </tr>
   <%  }
  db.close();%>
    </table>
    ...
    <center>
    <a href="kehuxinxi.jsp?currentPage=<%=currentPage-1 %>">上一页</a>&nbsp;
    <a href="kehuxinxi.jsp?currentPage=<%=currentPage+1 %>">下一页</a>
    &nbsp;&nbsp;共<%=totalPage %>页
   </center>
