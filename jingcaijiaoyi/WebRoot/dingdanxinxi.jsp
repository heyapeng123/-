...
<html>
  ...
  <% 
    ...
    <td width="200"><a href="dingdanxiangqing.jsp?id=<%=rs.getString(3) %>&nid=<%=rs.getInt(1) %> " >详情</a></td>
    </tr>
   <%  }
  db.close();%>
    </table>
    ...
    <center>
    <a href="dingdanxinxi.jsp?currentPage=<%=currentPage-1 %>">上一页</a>&nbsp;
    <a href="dingdanxinxi.jsp?currentPage=<%=currentPage+1 %>">下一页</a>
    &nbsp;&nbsp;共<%=totalPage %>页
   </center>
