...
<html>
  ...
  <body>
   ...
   currentPage=1;
    ...
    <tr>
    <td colspan="4" align="center"  height="50px"><h3>投诉信息(共<%=rows %>条记录)</h3></td>
    <td colspan="2" align="center"><input type="button" value="新增"  onClick="javascript:location.href='tousuxinzeng.jsp'" style="font-size: 25px;background-color: #999999;color: #ffffff;">
    </td>
  ...
  <% 
    ...
    <td width="700"><%=rs.getString(4) %></td>
    <td width="100"><a href="tousuxiugai.jsp?id=<%=rs.getInt(1) %>" >修改</a></td>
    <td width="100"><a href="tousudelete.jsp?id=<%=rs.getInt(1) %>" style="color:red; " onclick='return window.confirm("确定要删除此客户信息吗？请慎重！！！")'>删除</a></td>
    </tr>
   <%  }
  db.close();%>
    </table>
    ...
    <center>
    <a href="tousu.jsp?currentPage=<%=currentPage-1 %>">上一页</a>&nbsp;
    <a href="tousu.jsp?currentPage=<%=currentPage+1 %>">下一页</a>
    &nbsp;&nbsp;共<%=totalPage %>页
   </center>
