...
<body>
  ...
  <%
   ...
   %>
    <form  method="post" action="yuanliaoappend.jsp">
    <table style="text-align: center;margin: auto;font-size: 25px" >
    <tr>
    <%out.print("<td  colspan=2 align='center' height='100' width='500'><h3>增加原料</h3></td>"); %>
    </tr>
    <tr>
    <td width="500" height="100">原料编号：<%out.print("<input type='text' name='yuanliaobianhao'  >"); %>
    </td>
   
    <td width="500" height="100">原料名称：<%out.print("<input type='text' name='yuanliaomingcheng' >"); %>
    </td>
    </tr>
    
    <tr>
    <td width="500" height="100">市场价格：<%out.print("<input type='text' name='shichangjiage'  >"); %>
    </td>
